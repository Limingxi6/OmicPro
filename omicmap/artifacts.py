...
class ExperimentLayout:
    ...
    def from_config(cls, cfg: Mapping[str, Any], config_path: str | Path | None = None) -> "ExperimentLayout":
        ...
        result_base = Path(str(cfg.get("result_dir") or legacy_output or "results"))
        model_base = Path(str(cfg.get("model_dir") or "models"))
        return cls(
            run_name=run_name,
    ...
    def checkpoint_path(self, trait: str, fold: int, model_name: str = "omicmap") -> Path:
